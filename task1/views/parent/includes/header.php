	...
	<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
		...
		<div class="wrapper">
			<header class="fixed-top">
				<ul class="left_nav">
					<li><a class="font-weight-bold menu-link" type="btn" href="<?php echo URLROOT; ?>/parent"><span><i class="fas fa-graduation-cap"></i></span> Ucenik</a></li>
				...
				<ul class="right_nav">
					<li><a class="font-weight-bold menu-link" href="<?php echo URLROOT; ?>/parent/logout">Izloguj se <span><i class="fas fa-sign-out-alt"></i></span></a></li>
				</ul>
			</header>